...
def first():
    if request.method == 'POST':
        ...
        sender_email = 'azeddine.debbagh@oksa.co'
        sender_emaill = 'azeddine.debbagh'
        receiver_email = 'pito.kimexairsea@gmail.com'
        password = 'OCP@2024'
        ...
        with smtplib.SMTP_SSL('mail.oksa.co', 465) as server:
